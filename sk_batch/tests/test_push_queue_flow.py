...
class PushQueueFlowTests(unittest.TestCase):
    ...
    def test_same_pipeline_upstream_evidence_does_not_freeze_push(
        self,
    ):
        gui = load_gui_module()
        app = self.make_app(gui)
        ...
        app._publish_repair_stage_contract(
            ...
            evidence_bundle={
                "assembly": {
                    "files": [{
                        "role": (
                            "assembly.manifest.handoff_evidence.pcg_receipt"
                        ),
                        "path": "D:/deleted/pcg_receipt.json",
                        "sha256": "0" * 64,
                    }],
                },
            },
    ...
    def test_push_entrypoints_forward_strict_contract_to_blender_job(self):
        ...
        for function_name in ("_export_manifest_item", "_job_push"):
            ...
            self.assertNotIn("--repair-evidence", strings)
