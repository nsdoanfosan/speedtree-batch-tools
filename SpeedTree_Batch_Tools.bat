...
rem Launch the integrated tabbed GUI and exit this console immediately. The
rem guard performs native CLI build/diagnosis through hidden owned processes.
...
set "BLENDER_EXE_PATH=C:\Program Files\Blender Foundation\Blender 5.2\blender.exe"
